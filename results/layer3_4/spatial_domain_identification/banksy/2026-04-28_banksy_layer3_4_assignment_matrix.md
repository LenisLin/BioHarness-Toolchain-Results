...
| README quick start loads AnnData and passes a coordinate key tuple. | `README_QUICKSTART` | Semantic input and `coordinate_key_pair` parameter. | Backend call preparation and coordinate tuple conversion. | Evidence supports blueprint only. |
