...
## Recovery Migration Addendum

```yaml
review_pack_status: recovered_and_normalized
authority_status: blueprint
production_adapter_implemented: false
storage_location: NAS
```
...
- [../checks/recovery_migration_report.md](../checks/recovery_migration_report.md)
- [../checks/artifact_manifest.tsv](../checks/artifact_manifest.tsv)
- [../checks/sha256_manifest.tsv](../checks/sha256_manifest.tsv)

### Missing Artifacts

| Artifact | Status | Recovery attempts |
| --- | --- | --- |
| `environment_profiles/banksy.environment_probe_plan.md` | missing | not found in active tree, Git history, prior NAS pack, lower-case NAS results, or selected export search |
| `checks/post_cleanup_acceptance_report.md` | missing | not found in active tree, Git history, prior NAS pack, lower-case NAS results, or selected export search |
